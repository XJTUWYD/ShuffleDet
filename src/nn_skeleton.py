...
class ModelSkeleton:
  ...
  def _add_train_graph(self):
    ...
    # print('the grads_vars is :'+str(grads_vars))
  ...
  def _conv_bn_wioutfusion_relu_layer(
      self,layer_name, inputs,  filters,
  ...
  def _global_average_pooling(self, layer_name, inputs, stride, padding = 'VALID'):
  ...
  def dac_filter_prediction(self, boxes, probs, cls_idx, pred_conf):
